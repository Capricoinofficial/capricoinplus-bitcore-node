...
**Note**: To install services [insight-api](https://github.com/capricoinplus/capricoinplus-insight-api) and [insight-ui](https://github.com/capricoinplus/capricoinplus-insight-ui) you'll need to clone the repositories locally.
