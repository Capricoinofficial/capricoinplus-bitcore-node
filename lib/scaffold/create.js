...
var BASE_PACKAGE = {
  description: 'A full CapricoinPlus node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    /*
    'capricoinplus-bitcore-lib': '^' + bitcore.version,
    'capricoinplus-bitcore-node': version
    */
    'capricoinplus-bitcore-lib': 'https://github.com/Capricoinofficial/capricoinplus-bitcore-lib',
    'capricoinplus-bitcore-node': 'https://github.com/Capricoinofficial/capricoinplus-bitcore-node'
